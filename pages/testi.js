      ...
      <div class='p-4 bg-white shadow-xl max-w-xl rounded-xl flex justify-start dark:bg-gray-800 md:flex-row flex-col gap-4'>
        <div class='relative'>
          <img
            ...
            class='rounded-xl w-full md:w-auto md:max-h-40'
          />
          ...
          <div class='flex items-start my-2 md:m-0'>
            <div class='relative'>
              ...
              <svg
                ...
                height='10'
                fill='currentColor'
                class='fill-current text-white bg-blue-600 rounded-full p-1 absolute bottom-0 right-0 w-4 h-4 -mx-1 -my-1'
                viewBox='0 0 1792 1792'
                xmlns='http://www.w3.org/2000/svg'
              >
            ...
            <div class='flex flex-col items-start justify-center ml-2'>
              <span class='text-gray-600 dark:text-gray-200 text-sm flex items-center'>
                Charlie Rabiller
                <span class='w-2 h-2 block bg-green-500 rounded-full ml-1'></span>
              </span>
